# Pickaxe on Koke - Setup help

Everything you need to get **Pickaxe on Koke** running, step by step. If something goes wrong, check *Troubleshooting* at the end.

## What you need

- Minecraft **Bedrock Edition** 1.20.70 or newer (Windows, phone, console or a Bedrock server)

## Install and start

1. Download **`Pickaxe-on-Koke-v2.17.0.mcaddon`** from the [Releases page](../../releases) - or directly from this repository.
...
- Craft the tools in a crafting table (Excavator, Vein Miner, Rainbow Pickaxe, Lumberjack Axe). The **Tunnel Bore** is available in the creative inventory (*Equipment*).
- Break a block with a tool to mine the area/vein/tree it is made for.
